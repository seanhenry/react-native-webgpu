...
Value DeviceHostObject::get(Runtime &runtime, const PropNameID &propName) {
    ...
    if (name == "createRenderPipeline") {
        return WGPU_FUNC_FROM_HOST_FUNC(createRenderPipeline, 1, [this]) {
            ...
            return Object::createFromHostObject(runtime, std::make_shared<RenderPipelineHostObject>(pipeline, _context, std::move(label)));
        });
    }
    ...
    if (name == "createShaderModule") {
        return WGPU_FUNC_FROM_HOST_FUNC(createShaderModule, 1, [this]) {
            ...
            return Object::createFromHostObject(runtime, std::make_shared<ShaderModuleHostObject>(shader, _context, std::move(label)));
        });
    }
    ...
    if (name == "createTexture") {
        return WGPU_FUNC_FROM_HOST_FUNC(createTexture, 1, [this]) {
            ...
            return Object::createFromHostObject(runtime, std::make_shared<TextureHostObject>(texture, _context, std::move(label), false));
        });
    }
    ...
    if (name == "createBindGroup") {
        return WGPU_FUNC_FROM_HOST_FUNC(createBindGroup, 1, [this]) {
            ...
            return Object::createFromHostObject(runtime, std::make_shared<BindGroupHostObject>(bindGroup, _context, std::move(label)));
        });
    }
    ...
    if (name == "createSampler") {
        return WGPU_FUNC_FROM_HOST_FUNC(createSampler, 1, [this]) {
            ...
            return Object::createFromHostObject(runtime, std::make_shared<SamplerHostObject>(sampler, _context, std::move(label)));
        });
    }
