...
#define WGPU_HAS_PROP(__obj, __propName) (__obj.hasProperty(runtime, #__propName) && !__obj.getProperty(runtime, #__propName).isNull() && !__obj.getProperty(runtime, #__propName).isUndefined())
#define WGPU_BOOL_OPT(__obj, __propName, __default) WGPU_HAS_PROP(__obj, __propName) ? __obj.getProperty(runtime, #__propName).asBool() : __default
#define WGPU_UTF8_OPT(__obj, __propName, __default) WGPU_HAS_PROP(__obj, __propName) ? __obj.getProperty(runtime, #__propName).asString(runtime).utf8(runtime) : __default
#define WGPU_NUMBER_OPT(__obj, __propName, __type, __default) WGPU_HAS_PROP(__obj, __propName) ? (__type)__obj.getProperty(runtime, #__propName).asNumber() : __default
#define WGPU_HOST_OBJ_VALUE_OPT(__obj, __propName, __type, __default) WGPU_HAS_PROP(__obj, __propName) ? __obj.getPropertyAsObject(runtime, #__propName).asHostObject<__type>(runtime)->getValue() : __default
...
inline void jsLogValues([[maybe_unused]] Runtime &runtime, [[maybe_unused]] const char *functionName, [[maybe_unused]] const Value *arguments, [[maybe_unused]] size_t size) {
#ifdef DEBUG
    runtime.global()
...
inline void jsLog([[maybe_unused]] Runtime &runtime, [[maybe_unused]] const char *functionName, [[maybe_unused]] std::initializer_list<std::string> message) {
#ifdef DEBUG
...
inline void jsLogFuncArgs([[maybe_unused]] Runtime &runtime, [[maybe_unused]] const char *logFunctionName, [[maybe_unused]] const char *functionName, [[maybe_unused]] const Value *arguments, [[maybe_unused]] size_t size, [[maybe_unused]] const char *file, [[maybe_unused]] size_t line) {
#ifdef DEBUG
    std::vector<Value> args;
