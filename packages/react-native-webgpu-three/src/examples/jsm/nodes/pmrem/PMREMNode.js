...
import {addNodeClass} from 'three/examples/jsm/nodes/core/Node.js';
import {texture} from 'three/examples/jsm/nodes/accessors/TextureNode.js';
import {textureCubeUV} from 'three/examples/jsm/nodes/pmrem/PMREMUtils.js';
...
function _getPMREMFromTexture(texture) {
  ...
  if (pmremVersion !== texture.pmremVersion) {
    if (texture.isCubeTexture) {
      ...
      // FIXED: Use instance _generator
      cacheTexture = this._generator.fromEquirectangular(texture, cacheTexture);
    }
  ...
  updateBefore() {
    ...
    if (pmremVersion !== texture.pmremVersion) {
      if (texture.isPMREMTexture === true) {
        ...
        // FIXED: Call with `this`
        pmrem = _getPMREMFromTexture.call(this, texture);
      }
