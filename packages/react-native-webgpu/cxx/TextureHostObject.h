...
public:
    explicit TextureHostObject(WGPUTexture value, std::shared_ptr<WGPUContext> context, std::string label, bool isSurfaceTexture): _value(value), _context(context), _label(label), _isSurfaceTexture(isSurfaceTexture) {}
