...
public:
    explicit CommandBufferHostObject(WGPUCommandBuffer value, std::shared_ptr<WGPUContext> context, std::string label): _value(value), _context(context), _label(label) {}
