...
const char* WGPUCompositeAlphaModeToString(WGPUCompositeAlphaMode alphaMode) {
    switch (alphaMode) {
        case WGPUCompositeAlphaMode_Premultiplied: return "premultiplied";
        case WGPUCompositeAlphaMode_Opaque: return "opaque";
        case WGPUCompositeAlphaMode_Force32: return "force32";
        case WGPUCompositeAlphaMode_Inherit: return "inherit";
        case WGPUCompositeAlphaMode_Unpremultiplied: return "unpremultiplied";
        case WGPUCompositeAlphaMode_Auto: return "auto";
        default: return "auto";
    }
}
...
WGPUPrimitiveTopology StringToWGPUPrimitiveTopology(const char *topology) {
    if (strcmp(topology, "point-list") == 0) { return WGPUPrimitiveTopology_PointList; }
    if (strcmp(topology, "line-list") == 0) { return WGPUPrimitiveTopology_LineList; }
    if (strcmp(topology, "line-strip") == 0) { return WGPUPrimitiveTopology_LineStrip; }
    if (strcmp(topology, "triangle-list") == 0) { return WGPUPrimitiveTopology_TriangleList; }
    if (strcmp(topology, "triangle-strip") == 0) { return WGPUPrimitiveTopology_TriangleStrip; }
    if (strcmp(topology, "force32") == 0) { return WGPUPrimitiveTopology_Force32; }
    return WGPUPrimitiveTopology_PointList;
}

WGPULoadOp StringToWGPULoadOp(const char *str) {
    if (strcmp(str, "clear") == 0) { return WGPULoadOp_Clear; }
    if (strcmp(str, "load") == 0) { return WGPULoadOp_Load; }
    if (strcmp(str, "force32") == 0) { return WGPULoadOp_Force32; }
    return WGPULoadOp_Undefined;
}

WGPUStoreOp StringToWGPUStoreOp(const char *str) {
    if (strcmp(str, "store") == 0) { return WGPUStoreOp_Store; }
    if (strcmp(str, "discard") == 0) { return WGPUStoreOp_Discard; }
    if (strcmp(str, "force32") == 0) { return WGPUStoreOp_Force32; }
...
WGPUVertexStepMode StringToWGPUVertexStepMode(const char *str) {
    if (strcmp(str, "vertex") == 0) { return WGPUVertexStepMode_Vertex; }
    if (strcmp(str, "instance") == 0) { return WGPUVertexStepMode_Instance; }
    return WGPUVertexStepMode_Vertex;
}

WGPUCullMode StringToWGPUCullMode(const char *str) {
    if (strcmp(str, "none") == 0) { return WGPUCullMode_None; }
    if (strcmp(str, "front") == 0) { return WGPUCullMode_Front; }
    if (strcmp(str, "back") == 0) { return WGPUCullMode_Back; }
    return WGPUCullMode_None;
}

WGPUCompareFunction StringToWGPUCompareFunction(const char *str) {
    if (strcmp(str, "never") == 0) { return WGPUCompareFunction_Never; }
    if (strcmp(str, "less") == 0) { return WGPUCompareFunction_Less; }
    if (strcmp(str, "equal") == 0) { return WGPUCompareFunction_Equal; }
    if (strcmp(str, "less-equal") == 0) { return WGPUCompareFunction_LessEqual; }
    if (strcmp(str, "greater") == 0) { return WGPUCompareFunction_Greater; }
    if (strcmp(str, "not-equal") == 0) { return WGPUCompareFunction_NotEqual; }
    if (strcmp(str, "greater-equal") == 0) { return WGPUCompareFunction_GreaterEqual; }
...
WGPUMipmapFilterMode StringToWGPUMipmapFilterMode(const char *str) {
    if (strcmp(str, "nearest") == 0) { return WGPUMipmapFilterMode_Nearest; }
    if (strcmp(str, "linear") == 0) { return WGPUMipmapFilterMode_Linear; }
...
WGPUIndexFormat StringToWGPUIndexFormat(const char *str) {
    if (strcmp(str, "uint16") == 0) { return WGPUIndexFormat_Uint16; }
    if (strcmp(str, "uint32") == 0) { return WGPUIndexFormat_Uint32; }
    return WGPUIndexFormat_Undefined;
}

WGPUSamplerBindingType StringToWGPUSamplerBindingType(const char *str) {
    if (strcmp(str, "filtering") == 0) { return WGPUSamplerBindingType_Filtering; }
    if (strcmp(str, "non-filtering") == 0) { return WGPUSamplerBindingType_NonFiltering; }
    if (strcmp(str, "comparison") == 0) { return WGPUSamplerBindingType_Comparison; }
    return WGPUSamplerBindingType_Undefined;
}

WGPUTextureSampleType StringToWGPUTextureSampleType(const char *str) {
    if (strcmp(str, "float") == 0) { return WGPUTextureSampleType_Float; }
    if (strcmp(str, "unfilterable-float") == 0) { return WGPUTextureSampleType_UnfilterableFloat; }
    if (strcmp(str, "depth") == 0) { return WGPUTextureSampleType_Depth; }
    if (strcmp(str, "sint") == 0) { return WGPUTextureSampleType_Sint; }
    if (strcmp(str, "uint") == 0) { return WGPUTextureSampleType_Uint; }
    return WGPUTextureSampleType_Undefined;
}

WGPUAddressMode StringToWGPUAddressMode(const char *str) {
    if (strcmp(str, "repeat") == 0) { return WGPUAddressMode_Repeat; }
    if (strcmp(str, "mirror-repeat") == 0) { return WGPUAddressMode_MirrorRepeat; }
    if (strcmp(str, "clamp-to-edge") == 0) { return WGPUAddressMode_ClampToEdge; }
