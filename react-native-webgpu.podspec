...
Pod::Spec.new do |s|
  ...
  s.source_files = ["cxx/*.{hpp,h,cpp,c}", "cxx/ios/*.{hpp,h,m,mm,cpp,c}", "submodules/wgpu-native/ffi/webgpu-headers/webgpu.h", "submodules/wgpu-native/ffi/wgpu.h"]

  pods_root = ENV['PWD']
  relative_path_to_libs = Pathname.new("#{__dir__}/bin").relative_path_from(Pathname.new(pods_root)).to_s
  s.user_target_xcconfig = {
    "OTHER_LDFLAGS[sdk=iphonesimulator*]" => '$(inherited) -l"wgpu_native_iossim_x86_64_aarch64"',
