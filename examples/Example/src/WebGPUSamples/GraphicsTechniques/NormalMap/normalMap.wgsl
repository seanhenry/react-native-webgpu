const modeAlbedoTexture: u32 = 0;
const modeNormalTexture: u32 = 1;
const modeDepthTexture: u32 = 2;
const modeNormalMap: u32 = 3;
const modeParallaxScale: u32 = 4;
const modeSteepParallax: u32 = 5;
...
fn fragmentMain(input: VertexOutput) -> @location(0) vec4f {
  ...
  switch (mapInfo.mode) {
    ...
    default: {
      ...
      let diffuseLight = mapInfo.lightIntensity * max(dot(lightDirVS, normalVS), 0.0) / lightSqrDist;
