...
export const GLTFLoader = () => {
  const onCreateSurface: ThreeWebGpuViewProps['onCreateSurface'] = async ({ context, rendererParameters }) => {
    ...
    function init() {
      camera = new THREE.PerspectiveCamera( 45, context.width / context.height, 0.25, 20 );
      ...
      new RGBELoader()
        ...
        .load( 'royal_esplanade_1k.hdr', function ( texture ) {
          ...
          const loader = new ThreeGTLFLoader().setPath( `${THREE_EXAMPLES_BASE_URL}/models/gltf/DamagedHelmet/glTF/` );
