...
export const NormalMap = () => {
  ...
  const onCreateSurface: WebGpuViewProps['onCreateSurface'] = async ({
    ...
    interface GUISettings {
      ...
      depthScale: number;
      depthLayers: number;
      Texture: keyof typeof TextureAtlas;
      'Reset Light': () => void;
    }
    ...
    let woodAlbedoTexture: GPUTexture;
    {
      const imageBitmap = await createImageBitmap(
        require('../../assets/img/wood_albedo.png'),
      );
    ...
    {
      const imageBitmap = await createImageBitmap(
        require('../../assets/img/spiral_normal.png'),
      );
    ...
    {
      const imageBitmap = await createImageBitmap(
        require('../../assets/img/spiral_height.png'),
      );
    ...
    {
      const imageBitmap = await createImageBitmap(
        require('../../assets/img/toybox_normal.png'),
      );
    ...
    {
      const imageBitmap = await createImageBitmap(
        require('../../assets/img/toybox_height.png'),
      );
